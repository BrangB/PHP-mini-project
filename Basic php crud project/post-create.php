                    ...
                    <form action="post-create.php" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description"  class="form-control <?php if($desc_err !== '') : ?> is-invalid <?php endif ?>" placeholder="Enter post description" value=<?php echo $desc ?>></textarea>
                                <span class="text-danger"><?php echo $desc_err ?></span>
                            </div>

                    </div>
                    <div class="card-footer">
                        <button type="submit" name="create_post_btn" class="btn btn-md btn-primary" >Create</button>
                    </div>
                    </form>
                </div>
            </div>
